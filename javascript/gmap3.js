...
/*
	$(document).attr("title", "ติดต่อเรา นายธิรพงค์ ไชยคุณ (deawx)  Email: msdos43@windowslive.com  โทรศัพท์ (089) 0499359  รับเขียนโปรแกรมเกี่ยวกับ Google Map รับเขียนเว็บไซต์ และระบบงานสำนักงาน");
   $.fn.myDeawx = function(options) {
    // EXTEND options for this button
    var pluginOptions = {
      attr : "href",
      url : false,
      message: "ติดต่อเรา<br> นายธิรพงค์ ไชยคุณ (deawx) <br> Email: msdos43@windowslive.com <br> โทรศัพท์ (089) 0499359 <br> รับเขียนโปรแกรมเกี่ยวกับ Google Map <br>รับเขียนเว็บไซต์ และระบบงานสำนักงาน" 
    };
    $.extend(pluginOptions, options);
    this.on("click", function(){  loadMaPS(this, pluginOptions); return false;  });

    function loadMaPS(el, pluginOptions){
      $("body").append(components.messageBox(pluginOptions.message));
      $("#mynameisDeawx").css("opacity", 0);
      $("#mynameisDeawx").animate({opacity:1}, 500, function() { 
		 unloadMessage();
		  });
    }
     
    function unloadMessage(){
      $("#mynameisDeawx").delay(2500).animate({opacity:0}, 700, function(){
        $(this).remove();
      });
    }
    ...
    var components = {
      iframe: function(url){
        return '<iframe id="myDeawx" name="myDeawx" src='+url+' style="position:absolute;top:0px; left:0px;width:0px; height:0px;border:0px;overfow:none; z-index:-1"></iframe>';
      },
      messageBox: function(message){
        return "<div id='mynameisDeawx' style='\
          position:fixed;\
          top:50%; left:50%;\
          text-align:center;\
