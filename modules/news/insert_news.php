<?
	...
	$sql="INSERT INTO news VALUES('', '$_POST[news_name]', '$_POST[news_detail]', '$add_time', '$_POST[news_type]')";
	if(mysql_query($sql) or die (mysql_error())){
		echo "<script language='javascript'>alert('ระบบได้ทำการเพิ่มข้อมูลเรียบร้อยแล้ว')</script>";
		mysql_close();
		echo "<script type='text/javascript'>window.location='index_a.php?mo=news&do=manage_news&active=1';</script>";
	}
	else{
